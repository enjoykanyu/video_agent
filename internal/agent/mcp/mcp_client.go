...
func (m *MCPClientManager) RefreshConnections(ctx context.Context, servers []types.MCPServer) error {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *MCPClientManager) connectServer(ctx context.Context, server types.MCPServer) (*MCPClientEntry, error) {
...
func (m *MCPClientManager) EnsureConnected(ctx context.Context, server types.MCPServer) error {
	m.mu.RLock()
...
func (m *MCPClientManager) ReconnectServer(ctx context.Context, server types.MCPServer) error {
	m.mu.Lock()
	defer m.mu.Unlock()
